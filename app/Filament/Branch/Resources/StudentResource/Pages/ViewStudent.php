                ...
                Infolists\Components\Section::make('Educational Qualifications')
                    ->schema([
                        Infolists\Components\RepeatableEntry::make('studentDetail.educational_qualifications')
                            ->label('')
                            ->schema([
                                Infolists\Components\TextEntry::make('institution')->label('Institution'),
                                Infolists\Components\TextEntry::make('qualification')->label('Qualification'),
                                Infolists\Components\TextEntry::make('year')->label('Year')->default('—'),
                            ])
                            ->columns(3)
                            ->columnSpanFull(),
                    ])
                    ...
                    ->schema([
                        Infolists\Components\RepeatableEntry::make('studentDetail.work_experience')
                            ...
                            ->schema([
                                ...
                                Infolists\Components\TextEntry::make('start_date')->label('Start')->default('—'),
                                Infolists\Components\TextEntry::make('end_date')->label('End')->default('—'),
                                Infolists\Components\TextEntry::make('description')->label('Description')->default('—')->columnSpan(2),
                            ])
                            ->columns(3)
                            ->columnSpanFull(),
                    ])
                    ...
                    ->schema([
                        Infolists\Components\RepeatableEntry::make('studentDetail.emergency_contacts')
                            ...
                            ->schema([
                                ...
                                Infolists\Components\TextEntry::make('relationship')->label('Relationship'),
                            ])
                            ->columns(3)
                            ->columnSpanFull(),
                    ])
