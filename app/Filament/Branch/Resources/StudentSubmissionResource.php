...
use App\Filament\Branch\Resources\StudentSubmissionResource\Pages;
                ...
                Forms\Components\Section::make('Submission Details')
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('student_name')
                            ->label('Student')
                            ->disabled()
                            ->afterStateHydrated(fn ($component, ?StudentSubmission $record) =>
                        ...
                        Forms\Components\TextInput::make('module_name')
                            ...
                            ->disabled()
                            ->afterStateHydrated(fn ($component, ?StudentSubmission $record) =>
                                $component->state($record?->module?->title ?? '—')
                            ),
                    ])->columns(2),
                ...
                Tables\Filters\Filter::make('course_module')
                    ...
                    ->indicateUsing(function (array $data): array {
                        ...
                        if (!empty($data['course_id'])) {
                            ...
                            if ($course) {
                                $indicators[] = Tables\Filters\Indicator::make('Course: ' . $course->title)
                        ...
                        if (!empty($data['module_id']) && !empty($data['course_id'])) {
                            ...
                            if ($module) {
                                $indicators[] = Tables\Filters\Indicator::make('Module: ' . $module->title)
            ...
            ->bulkActions([
                Tables\Actions\BulkActionGroup::make([
                    Tables\Actions\DeleteBulkAction::make()
                        ...
                        ->modalDescription('This will permanently delete all selected submissions and their files. This cannot be undone.')
