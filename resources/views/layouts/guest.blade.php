            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden lg:flex items-center space-x-2">
                    ...
                    <a href="{{ route('gallery') }}"
                        class="nav-link px-5 py-2.5 text-sm font-bold rounded-xl {{ request()->routeIs('gallery') ? 'text-white gradient-primary shadow-lg' : 'text-gray-700 hover:bg-gray-100' }} transition-all duration-300">
                        <div class="flex items-center space-x-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="flex space-x-4">
                        <!-- Facebook -->
                        <a href="https://www.facebook.com/share/1E29EPbu2R/"
                            target="_blank"
                        ...
                        <!-- Twitter - hidden -->
                        <a href="#"
                            class="hidden w-12 h-12 rounded-xl bg-white/10 hover:bg-white/20 backdrop-blur-sm items-center justify-center transition-all duration-300 hover:scale-110">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
