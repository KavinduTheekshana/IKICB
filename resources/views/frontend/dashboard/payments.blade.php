    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div>
                ...
                <p class="text-base sm:text-lg text-gray-300">View all your transactions and payment records</p>
            </div>
            @if($payments->count() > 0)
                <div class="flex items-center">
                    <div class="px-4 py-2 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20">
                        <span class="text-xs sm:text-sm text-gray-300">Total Payments:</span>
                        <span class="text-lg sm:text-xl font-black text-yellow-500 ml-2">{{ $payments->total() }}</span>
                    </div>
                </div>
            @endif
        </div>
...
<section class="bg-white border-b border-gray-200 sticky top-20 z-40 shadow-sm">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-x-auto">
        <nav class="flex space-x-4 sm:space-x-8 -mb-px min-w-max">
            ...
            <a href="{{ route('dashboard.payments') }}" class="group inline-flex items-center py-4 px-1 border-b-4 border-yellow-500 text-yellow-600 font-black text-xs sm:text-sm transition-all whitespace-nowrap">
                <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
