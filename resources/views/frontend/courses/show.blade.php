                                        ...
                                        <div class="flex flex-wrap sm:flex-nowrap items-start gap-x-4 gap-y-2 mb-3">
                                            ...
                                            <div class="flex-shrink-0">
                                                ...
                                                @elseif($module->is_free)
                                                    <span class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-bold bg-yellow-100 text-yellow-800 border border-yellow-300 whitespace-nowrap">
                                                        <svg class="h-4 w-4 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
